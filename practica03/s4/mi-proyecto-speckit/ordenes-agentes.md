...
- [x] Genera y corre tests unitarios según test-spec.md
- [x] Genera y corre el test de integración según test-spec.md
- [x] Reporta el % de cobertura y qué líneas quedaron sin probar
...
**Criterios de aceptación de esta tarea:**
- [x] Revisa secretos expuestos, validación de entradas, manejo de excepciones
...
- [x] Presenta el veredicto y, si aplica, los 2-3 problemas más importantes
